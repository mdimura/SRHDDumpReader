    ...
    _id(id),_size(0),_cost(0),_durability(0.0),_techLevel(0),_locationType(locationType),_locationId(locationId)
{
    ...
    QStringList eqOptions;
    eqOptions<<"IName"<<"IType"<<"Owner"<<"Size"<<"Cost"<<"Durability"<<"TechLevel"<<"ISpecialName"<<"LandType";
    ...
    while (!line.isNull())
    {
        ...
        switch(eqOptions.indexOf(varname))
        {
        case 0://IName
            _name=value.remove("</color>");
            _name.remove('"');
        ...
        case 7://ISpecialName
            ...
            break;
        case 8://LandType
            extraFields[varname]=intToLandType.value(value.toInt());
            break;
        default:
...
QString Equipment::locationTypeString() const
{
    ...
    case kPlanetTreasure:
        return QObject::tr("Planet/treasure");
    }
    return "";
}
